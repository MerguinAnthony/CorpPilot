 ...
 */
final class Version20240106194844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE number_day_off (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, available DOUBLE PRECISION NOT NULL, got DOUBLE PRECISION NOT NULL, got_out_period DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_E5FE46F99D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vacation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, approved VARBINARY(255) NOT NULL, INDEX IDX_E3DADF75A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
