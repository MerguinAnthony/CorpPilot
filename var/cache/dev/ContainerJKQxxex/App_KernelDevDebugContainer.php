...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        ...
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.user_image'], [['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['onFlush'], 'turbo.doctrine.event_listener'], [['postFlush'], 'turbo.doctrine.event_listener'], [['preRemove'], 'vich_uploader.listener.remove.user_image'], [['postFlush'], 'vich_uploader.listener.remove.user_image'], [['prePersist'], 'vich_uploader.listener.upload.user_image'], [['preUpdate'], 'vich_uploader.listener.upload.user_image']]);
    }
