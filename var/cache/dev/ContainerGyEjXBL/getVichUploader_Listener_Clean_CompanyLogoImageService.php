 ...
 */
class getVichUploader_Listener_Clean_CompanyLogoImageService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.company_logo_image' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.company_logo_image'])) {
            return $container->privates['vich_uploader.listener.clean.company_logo_image'];
        }

        return $container->privates['vich_uploader.listener.clean.company_logo_image'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('company_logo_image', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
