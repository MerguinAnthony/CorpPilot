...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\CompanyProfileController' => 'getCompanyProfileControllerService',
            'App\\Controller\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\LeaveManagementController' => 'getLeaveManagementControllerService',
            ...
            'App\\Controller\\StaffVacationController' => 'getStaffVacationControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.company_logo_image' => 'getSmartUniqueNamer_CompanyLogoImageService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.signature_image' => 'getSmartUniqueNamer_SignatureImageService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.user_image' => 'getSmartUniqueNamer_UserImageService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/Twig/CustomFiltersExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('tQWQa7vTfc', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xJPQ8TkAac', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8KCfJ7DzmD', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hLGwo-Y5pF', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\NumberDayOffRepository' => ['privates', 'App\\Repository\\NumberDayOffRepository', 'getNumberDayOffRepositoryService', true],
            'App\\Repository\\SignIdRepository' => ['privates', 'App\\Repository\\SignIdRepository', 'getSignIdRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
            'App\\Repository\\VacationRepository' => ['privates', 'App\\Repository\\VacationRepository', 'getVacationRepositoryService', true],
        ], [
            'App\\Repository\\CompanyRepository' => '?',
            'App\\Repository\\NumberDayOffRepository' => '?',
            'App\\Repository\\SignIdRepository' => '?',
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Z+fITirxxJ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('+K-14rFu4I', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oFfMGC+iLa', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UFAblaPmD2', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UCN7zkqzBc', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cbXPzGEyU+', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        return $container->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'vich_uploader.listener.clean.company_logo_image' => ['privates', 'vich_uploader.listener.clean.company_logo_image', 'getVichUploader_Listener_Clean_CompanyLogoImageService', true],
            'vich_uploader.listener.clean.signature_image' => ['privates', 'vich_uploader.listener.clean.signature_image', 'getVichUploader_Listener_Clean_SignatureImageService', true],
            'vich_uploader.listener.clean.user_image' => ['privates', 'vich_uploader.listener.clean.user_image', 'getVichUploader_Listener_Clean_UserImageService', true],
            'vich_uploader.listener.remove.company_logo_image' => ['privates', 'vich_uploader.listener.remove.company_logo_image', 'getVichUploader_Listener_Remove_CompanyLogoImageService', true],
            'vich_uploader.listener.remove.signature_image' => ['privates', 'vich_uploader.listener.remove.signature_image', 'getVichUploader_Listener_Remove_SignatureImageService', true],
            'vich_uploader.listener.remove.user_image' => ['privates', 'vich_uploader.listener.remove.user_image', 'getVichUploader_Listener_Remove_UserImageService', true],
            'vich_uploader.listener.upload.company_logo_image' => ['privates', 'vich_uploader.listener.upload.company_logo_image', 'getVichUploader_Listener_Upload_CompanyLogoImageService', true],
            'vich_uploader.listener.upload.signature_image' => ['privates', 'vich_uploader.listener.upload.signature_image', 'getVichUploader_Listener_Upload_SignatureImageService', true],
            'vich_uploader.listener.upload.user_image' => ['privates', 'vich_uploader.listener.upload.user_image', 'getVichUploader_Listener_Upload_UserImageService', true],
        ], [
            ...
            'vich_uploader.listener.clean.company_logo_image' => '?',
            'vich_uploader.listener.clean.signature_image' => '?',
            'vich_uploader.listener.clean.user_image' => '?',
            'vich_uploader.listener.remove.company_logo_image' => '?',
            'vich_uploader.listener.remove.signature_image' => '?',
            'vich_uploader.listener.remove.user_image' => '?',
            'vich_uploader.listener.upload.company_logo_image' => '?',
            'vich_uploader.listener.upload.signature_image' => '?',
            'vich_uploader.listener.upload.user_image' => '?',
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.user_image'], [['preUpdate'], 'vich_uploader.listener.clean.company_logo_image'], [['preUpdate'], 'vich_uploader.listener.clean.signature_image'], [['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['onFlush'], 'turbo.doctrine.event_listener'], [['postFlush'], 'turbo.doctrine.event_listener'], [['preRemove'], 'vich_uploader.listener.remove.user_image'], [['postFlush'], 'vich_uploader.listener.remove.user_image'], [['prePersist'], 'vich_uploader.listener.upload.user_image'], [['preUpdate'], 'vich_uploader.listener.upload.user_image'], [['preRemove'], 'vich_uploader.listener.remove.company_logo_image'], [['postFlush'], 'vich_uploader.listener.remove.company_logo_image'], [['prePersist'], 'vich_uploader.listener.upload.company_logo_image'], [['preUpdate'], 'vich_uploader.listener.upload.company_logo_image'], [['preRemove'], 'vich_uploader.listener.remove.signature_image'], [['postFlush'], 'vich_uploader.listener.remove.signature_image'], [['prePersist'], 'vich_uploader.listener.upload.signature_image'], [['preUpdate'], 'vich_uploader.listener.upload.signature_image']]);
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(new \App\Twig\CustomFiltersExtension());
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'vich_uploader.mappings' => [
                'user_image' => [
                    'uri_prefix' => '/assets/Img/profile_picture',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/assets/Img/profile_picture'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.user_image',
                        'options' => [
                ...
                'company_logo_image' => [
                    'uri_prefix' => '/assets/Img/company_logo',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/assets/Img/company_logo'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.company_logo_image',
                        'options' => [
                ...
                'signature_image' => [
                    'uri_prefix' => '/assets/Img/signature',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/assets/Img/signature'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.signature_image',
                        'options' => [
